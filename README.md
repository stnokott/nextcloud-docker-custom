![Docker Image Size with architecture (latest by date/latest semver)](https://img.shields.io/docker/image-size/stnokott/nextcloud-custom?arch=amd64&label=linux%2Famd64)
